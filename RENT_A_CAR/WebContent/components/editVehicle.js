				...
				<table border="0" style = "width: 100%; text-align: center">
					...
					<tr>
						<td style = "width: 100%" colspan="2">
							<input class="idSubmit" type="submit" value="Edit" v-on:click="edit">
						</td>
					</tr>
				</table>
			</form>
...
`
		...
		edit : function () {
			...
			if(isValid)
			{
				this.vehicle.objectId = this.rentACarObject.id;
					...
					axios.put('rest/vehicleService/'+ this.vehicle.id,this.vehicle)
								.then(response => 
								{
									...
									if(response.data==null || response.data==""){
										...
										axios
											.put('rest/objectsService/editVehicle/' + this.vehicle.objectId + '/' + this.vehicle.id + '/' + this.usernameParam,this.vehicle)
	...
	mounted()
	{
		...
		axios
			.get('rest/vehicleService/getVehicle/' + this.id)
