		...
		search : function()
		{
			...
			axios
				...
				{	
					...
					;
					//searching by vehicle type
					this.objects = this.objects.filter(object => (object.vehicles!=null && (this.tip=="" || object.vehicles.some(vehicle => vehicle.type.toLowerCase().include(this.tip.toLowerCase())))))	//if both unchecked -> cool
